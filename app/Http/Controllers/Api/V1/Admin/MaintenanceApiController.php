...
class MaintenanceApiController extends Controller
{
    public function index()
    {
        ...
        return new MaintenanceResource(Maintenance::with(['area', 'quien_lo_realiza', 'created_by'])->get());
    }
    ...
    public function show(Maintenance $maintenance)
    {
        ...
        return new MaintenanceResource($maintenance->load(['area', 'quien_lo_realiza', 'created_by']));
    }
