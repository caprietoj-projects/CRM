        ...
        <form method="POST" action="{{ route("admin.fichas-tecnicas.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('teclado') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="teclado" id="teclado" value="1" {{ old('teclado', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('mouse') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="mouse" id="mouse" value="1" {{ old('mouse', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('parlantes') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="parlantes" id="parlantes" value="1" {{ old('parlantes', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('camara') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="camara" id="camara" value="1" {{ old('camara', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('telefono_ip') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="telefono_ip" id="telefono_ip" value="1" {{ old('telefono_ip', 0) == 1 ? 'checked' : '' }}>
