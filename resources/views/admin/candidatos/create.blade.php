    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.candidatos.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ciudad') ? 'is-invalid' : '' }}" type="text" name="ciudad" id="ciudad" value="{{ old('ciudad', '') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('nivel_academico') ? 'is-invalid' : '' }}" name="nivel_academico" id="nivel_academico">
                    ...
                    @foreach(App\Models\Candidato::NIVEL_ACADEMICO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('nivel_academico', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_de_semestres') ? 'is-invalid' : '' }}" type="number" name="no_de_semestres" id="no_de_semestres" value="{{ old('no_de_semestres', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('graduado') ? 'is-invalid' : '' }}" name="graduado" id="graduado">
                    ...
                    @foreach(App\Models\Candidato::GRADUADO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('graduado', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('titulo_obtenido_superior') ? 'is-invalid' : '' }}" type="text" name="titulo_obtenido_superior" id="titulo_obtenido_superior" value="{{ old('titulo_obtenido_superior', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_de_grado_superior') ? 'is-invalid' : '' }}" type="text" name="fecha_de_grado_superior" id="fecha_de_grado_superior" value="{{ old('fecha_de_grado_superior') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('idioma') ? 'is-invalid' : '' }}" name="idioma" id="idioma">
                    ...
                    @foreach(App\Models\Candidato::IDIOMA_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('idioma', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('otro_idioma') ? 'is-invalid' : '' }}" type="text" name="otro_idioma" id="otro_idioma" value="{{ old('otro_idioma', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('habla') ? 'is-invalid' : '' }}" name="habla" id="habla">
                    ...
                    @foreach(App\Models\Candidato::HABLA_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('habla', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('habla'))
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('lectura') ? 'is-invalid' : '' }}" name="lectura" id="lectura">
                    ...
                    @foreach(App\Models\Candidato::LECTURA_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('lectura', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('escritura') ? 'is-invalid' : '' }}" name="escritura" id="escritura">
                    ...
                    @foreach(App\Models\Candidato::ESCRITURA_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('escritura', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('ofimatica') ? 'is-invalid' : '' }}" name="ofimatica" id="ofimatica">
                    ...
                    @foreach(App\Models\Candidato::OFIMATICA_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('ofimatica', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
