    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.proyectos-articulados.update", [$proyectosArticulado->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombre_del_estudiante') ? 'is-invalid' : '' }}" type="text" name="nombre_del_estudiante" id="nombre_del_estudiante" value="{{ old('nombre_del_estudiante', $proyectosArticulado->nombre_del_estudiante) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('curso') ? 'is-invalid' : '' }}" type="number" name="curso" id="curso" value="{{ old('curso', $proyectosArticulado->curso) }}" step="1" required>
                @if($errors->has('curso'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tema_del_proyecto') ? 'is-invalid' : '' }}" type="text" name="tema_del_proyecto" id="tema_del_proyecto" value="{{ old('tema_del_proyecto', $proyectosArticulado->tema_del_proyecto) }}" required>
